...
This document provides guidelines for internationalization of the Bbbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bbbit_en.ts` remains unchanged.
