Bbbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bbbit/files/Bbbit/bbbit-0.5.4/
...
http://gitorious.org/bbbit/bbbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bbbit-Qt notifications under Growl 1.3.
Increase required age of Bbbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBbbit properly when installing Bbbit-Qt over it. (Windows)
