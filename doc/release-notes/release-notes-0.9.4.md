Bbbit Core version 0.9.4 is now available from:

  https://bbbit.org/bin/0.9.4/
...
this update is incompatible with the Bbbit system and could lead to consensus
forks.

Bbbit Core released binaries from https://bbbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bbbit/+archive/ubuntu/bbbit
- A third-party or self-compiled Bbbit Core

upgrade to Bbbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
