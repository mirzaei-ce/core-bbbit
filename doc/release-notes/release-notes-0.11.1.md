Bbbit Core version 0.11.1 is now available from:

  <https://bbbit.org/bin/bbbit-core-0.11.1/>
...
(see https://github.com/bbbit/bbbit/pull/6795).
...
one was randomly violated by all deployed bbbit software prior to
...
Bbbit Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Bbbitj has done so for a similar span of time.
Bbbitjs and electrum have been more recently updated.
...
[1] On the Malleability of Bbbit Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/bbbit/paper_9.pdf
...
(see https://github.com/bbbit/bbbit/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libbbbitconsensus: avoid a crash in multi-threaded environments
