Bbbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bbbit/files/Bbbit/bbbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bbbit
...
New/changed settings (command-line or bbbit.conf file)
--------------------------------------------------------
