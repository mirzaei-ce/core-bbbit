Bbbit Core version 0.9.2.1 is now available from:

  https://bbbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BBT to 0.01 BBT
...
- Fix "Start bbbit on system login"
