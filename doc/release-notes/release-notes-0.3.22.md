Download URL: https://sourceforge.net/projects/bbbit/files/Bbbit/bbbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BBT fee schedule (users still pay 0.01 BBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bbbit00 - #bbbit99
