...
#if defined(NDEBUG)
# error "Bbbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bbbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s BBT additional fees, %d delta bytes\n",
