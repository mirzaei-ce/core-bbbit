...
#ifndef BBBIT_TEST_SCRIPTNUM10_H
#define BBBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bbbit Core 0.10.0, for cross-comparison.
 */
public:
