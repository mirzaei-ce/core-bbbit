...
#ifndef BBBIT_QT_BBBITUNITS_H
#define BBBIT_QT_BBBITUNITS_H
...
/** Bbbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BbbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BbbitUnits(QObject *parent);

    /** Bbbit units.
      @note Source: https://en.bbbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BBT,
...
typedef BbbitUnits::Unit BbbitUnit;

#endif // BBBIT_QT_BBBITUNITS_H
