...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bbbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bbbit Core"),
     ...
     * override -datadir in the bbbit.conf file in the default data directory
     * (to be consistent with bbbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
