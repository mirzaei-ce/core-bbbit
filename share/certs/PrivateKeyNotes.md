...
unlocked to sign the Bbbit-Qt.app bundle.
...
allowing somebody to distribute a Bbbit-Qt.app or bbbit-qt-setup.exe with a valid
...
that the bbbit-qt.exe file inside the installer had not been tampered with.
